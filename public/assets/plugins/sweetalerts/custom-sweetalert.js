...
//   }).then(function(result) {
//       if (result.value) {
//           window.location.href = '/presidente/encerrarvotacao';
//       }
//   });
// });
/* 
SCRIPT DA TRIBUNA
*/
$('.warning.tribuna').on('click', function() {
  swal({
      title: 'INICIAR TRIBUNA?',
      text: "",
      type: 'warning',
      showCancelButton: true,
      cancelButtonText: 'CANCELAR',
      ...
      if (result.value) {
          window.location.href = '/presidente/tribuna';
      }
  });
});
/* 
SCRIPT DA ORDEM DO DIA
*/
$('.warning.ordemdodia').on('click', function() {
  swal({
      // title: 'Iniciar Ordem do Dia?',
      title: 'INICIAR ORDEM DO DIA?',
      text: "",
      type: 'warning',
      showCancelButton: true,
      ...
      if (result.value) {
          window.location.href = '/presidente/ordemdodia';
      }
  });
});
/* 
SCRIPT FINALIZAR SESSÃO
*/
...
SCRIPT SUSPENDER
*/
$('.warning.suspender').on('click', function() {
  swal({
      title: 'SUSPENDER A SESSÃO?',
      text: "",
      type: 'warning',
      showCancelButton: true,
      cancelButtonText: 'CANCELAR',
