        ...
        <div id="custom_styles" class="col-lg-12 layout-spacing col-md-12">
            ...
            <div class="statbox widget box box-shadow">
                ...
                <div class="widget-content widget-content-area">
                    ...
                    <form action="{{ route('documento.atualizar', $documentos[0]['nrSequence']) }}" method="POST"
                        enctype="multipart/form-data">
                        @method('PUT')
                        <!-- ============================================================== -->
                        <!-- Start FORMULÁRIO here -->
                        <!-- ============================================================== -->
                        @include('sessao.gerenciar._partials.form')
                        <button class="btn btn-primary  mt-3" type="submit">SALVAR</button>
                    </form>

                    <div class="text-center">
                        <form action="{{ route('documento.excluir', ['nrSequence' => $documentos[0]['nrSequence']]) }}"
                            method="POST">
                            @csrf
                            @method('DELETE')
